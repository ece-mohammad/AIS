...
password_reset_urlpatterns = [
    ...
    path(
        "done/", views.MemberPasswordResetDoneView.as_view(), name="password_reset_done"
    ),
    path(
        "confirm/<slug:uidb64>/<slug:token>/",
        views.MemberPasswordResetConfirmView.as_view(),
        name="password_reset_confirm",
    ),
    path(
        "complete/",
        views.MemberPasswordResetCompleteView.as_view(),
...
password_change_urlpatterns = [
    ...
    path(
        "done/",
        views.MemberPasswordChangeDoneView.as_view(),
...
account_urlpatterns = [
    ...
    path(
        "deactivate/", views.MemberDeactivateView.as_view(), name="account_deactivate"
    ),

...
ACTIVE_MEMBERS_DATA: Final[List[Dict[str, str]]] = [
    dict(username="active_user_1", first_name="Active", last_name="User 1", email="active_user1@domain.com", password="test_password_1"),
    dict(username="active_user_2", first_name="Active", last_name="User 2", email="active_user2@domain.com", password="test_password_2"),
    dict(username="active_user_3", first_name="Active", last_name="User 3", email="active_user3@domain.com", password="test_password_3"),
]

INACTIVE_MEMBERS_DATA: Final[List[Dict[str, str]]] = [
    dict(username="inactive_user_1", first_name="Inactive", last_name="User 1", email="inactive_user1@domain.com", password="test_password_1", is_active=False),
    dict(username="inactive_user_2", first_name="Inactive", last_name="User 2", email="inactive_user2@domain.com", password="test_password_2", is_active=False),
    dict(username="inactive_user_3", first_name="Inactive", last_name="User 3", email="inactive_user3@domain.com", password="test_password_3", is_active=False),
]
...
class BaseMemberModelTestCase(TransactionTestCase):
    def setUp(self) -> None:
        self.members = Member.objects.bulk_create(
            [Member(**member_data) for member_data in ACTIVE_MEMBERS_DATA + INACTIVE_MEMBERS_DATA],
...
class TestMemberModel(BaseMemberModelTestCase):
    ...
    def test_member_absolute_url(self):
        ...
        self.assertEqual(member.get_absolute_url(), reverse_lazy("accounts:profile", kwargs={"user_name": member.username}))

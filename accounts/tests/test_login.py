...
from test.utils.helpers import client_login, page_in_response, response_user_logged_in
from typing import *
...
INVALID_CREDENTIALS_MESSAGE: Final[
    str
...
class TestLoginView(BaseLoginTestCase):
    ...
    def test_login_member_redirects_to_homepage(self):
        ...
        response = self.client.get(LogIn.get_url(), follow=True)
